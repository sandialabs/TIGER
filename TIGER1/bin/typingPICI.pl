...
system "perl $dir/makejobsPICI.pl > jobsPICI"; 
system "bash jobsPICI"; 
system "perl $dir/transposaser.pl $study"; 
system "perl $dir/selfblast.pl isles.fa > isles.invrep";
system "cat Isles/*/PICIphage.txt > PICIphage.txt"; 
